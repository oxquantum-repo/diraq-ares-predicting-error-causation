...
class Model(hmm.CategoricalHMM):
    ...
    def get_probabilities(self):
        ...
        p_readout_even = self.emissionprob_[0, 0]
        p_readout_odd = self.emissionprob_[1, 1]
        return p_init_even, p_spin_flip_even_to_odd, p_spin_flip_odd_to_even, p_readout_even, p_readout_odd

    def randomly_set_probabilities(
            self,
            p_init_even_prior: float, p_spin_flip_even_to_odd_prior: float,
            p_spin_flip_odd_to_even_prior, p_readout_prior_even: float, p_readout_prior_odd: float,
            p_init_even_prior_std=0.01, p_spin_flip_even_to_odd_prior_std=0.01,
            p_spin_flip_odd_to_even_prior_std=0.01, p_readout_even_prior_std=0.01, p_readout_odd_prior_std=0.01,
            tol=1e-3
    ):
        ...
        p_readout_even = beta_dist(p_readout_prior_even, p_readout_even_prior_std)
        p_readout_odd = beta_dist(p_readout_prior_odd, p_readout_odd_prior_std)
        ...
        p_readout_even = np.clip(p_readout_even, tol, 1 - tol)
        p_readout_odd = np.clip(p_readout_odd, tol, 1 - tol)

        return self.set_probabilities(p_init_even, p_spin_flip_even_to_odd, p_spin_flip_odd_to_even, p_readout_even, p_readout_odd)
