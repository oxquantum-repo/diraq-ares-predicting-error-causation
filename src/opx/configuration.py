...
resonator_LO = 7.5079 * u.GHz
mixer_resonator_g = 0.0
mixer_resonator_phi = -0.12
...
config = {
    ...
    "controllers": {
        "con1": {
            "analog_outputs": {
                1: {"offset": -0.0005},  # I qubit
                2: {"offset": -0.0006},  # Q qubit
                3: {"offset": -0.0039},  # I resonator
                4: {"offset": 0.004},  # Q resonator
                5: {"offset": 0.0},  # flux line
            },
            "digital_outputs": {},
            "analog_inputs": {
                1: {"offset": 0.04183969970703125, "gain_db": 10},  # I from down-conversion
                2: {"offset": 0.0584289326171875, "gain_db": 10},  # Q from down-conversion
            },
        },
    },
    "elements": {
        ...
        "mixer_resonator": [
            {
                "intermediate_frequency": resonator_IF,
                "lo_frequency": resonator_LO,
                "correction": IQ_imbalance(0.031, -0.131),
            }
        ],
    },
}