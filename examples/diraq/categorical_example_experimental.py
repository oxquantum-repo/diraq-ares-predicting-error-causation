...
measured_states = data['measured_states'].squeeze()
...
model_to_fit.set_start_prob(0.01)
...
predicted_states = model_to_fit.predict(measured_states[:200, :], plot=True)




model_to_fit.simulate_data(measurements=20, repeats=200, plot=True)